...
const lang = {
  lat: {
    ...
    // Hero
    hero_tagline:  'Premium Barber Shop · Beograd',
    ...
    about_body:    'Matko Barber Shop je mesto gde se susreću tradicija i moderan stil. Sa godinama iskustva u poslu, posvećeni smo svakom detalju — od preciznog šišanja do savršenog brijanja. Svaki klijent zaslužuje tretman koji odgovara njemu i samo njemu.',
    about_badge:   'God.\niskustva',
  ...
  cyr: {
    ...
    // Hero
    hero_tagline:  'Премиум Бербер Шоп · Београд',
    ...
    about_body:    'Матко Бербер Шоп је место где се сусрећу традиција и модеран стил. Са годинама искуства у послу, посвећени смо сваком детаљу — од прецизног шишања до савршеног бријања. Сваки клијент заслужује третман који одговара њему и само њему.',
    about_badge:   'Год.\nискуства',
...
/* ─────────────────────────────────────────────────────
   4. REVIEWS DATA (fake placeholder data)
───────────────────────────────────────────────────────*/
const REVIEWS = [
  {
    ...
    color: '#2d6a4f',
    stars: 5,
    date_lat: 'pre mesec dana',
    date_cyr: 'пре месец дана',
    text_lat: 'Odličan brod! Matko je pravi profesionalac — tačno zna šta hoćeš i isporuči savršen rezultat. Preporučujem svima!',
    text_cyr: 'Одличан бербер! Матко је прави професионалац — тачно зна шта хоћеш и испоручи савршен резултат. Препоручујем свима!',
  },
  {
    ...
    color: '#1d3557',
    stars: 5,
    date_lat: 'pre 2 meseca',
    date_cyr: 'пре 2 месеца',
    text_lat: 'Fantastična atmosfera, čista radnja i super ekipa. Šišanje je tačno onako kako sam zamišljao. Definitivno se vraćam!',
    text_cyr: 'Фантастична атмосфера, чиста радња и супер екипа. Шишање је тачно онако како сам замишљао. Дефинитивно се враћам!',
  },
  {
    name: 'Nikola Ilić',
    initials: 'NI',
    color: '#7b2d8b',
    stars: 5,
    date_lat: 'pre nedelju dana',
    date_cyr: 'пре недељу дана',
    text_lat: 'Brijanje britvom je bilo iskustvo za sebe. Topao peškir, savršena pena, precizno brijanje. Svaka preporuka!',
    text_cyr: 'Бријање бритвом је bilo искуство за себе. Топли пешкир, савршена пена, прецизно бријање. Свака препорука!',
  },
  {
    ...
    color: '#b5451b',
    stars: 5,
    date_lat: 'pre 3 meseca',
    date_cyr: 'пре 3 месеца',
    text_lat: 'Dolazim već godinu dana i uvek sam zadovoljan. Cene su fer, kvalitet konstantan. Matko je majstor svog zanata.',
    text_cyr: 'Долазим већ годину дана и увек сам задовољан. Цене су фер, квалитет константан. Матко је мајстор свог заната.',
  },
  {
    name: 'Luka Stanković',
    initials: 'LS',
    color: '#4a5568',
    stars: 5,
    date_lat: 'pre 2 nedelje',
    date_cyr: 'пре 2 недеље',
    text_lat: 'Top mesto! Brza usluga bez čekanja, lepo uređen prostor. Rezultat — odlično šišanje koje traje. 10/10',
    text_cyr: 'Топ место! Брза услуга без чекања, лепо уређен простор. Резултат — одлично шишање које траје. 10/10',
  },
  {
    name: 'Đorđe Marinković',
    initials: 'ĐM',
    color: '#2c7a5e',
    stars: 5,
    date_lat: 'pre 5 meseci',
    date_cyr: 'пре 5 месеци',
    text_lat: 'Konačno sam pronašao berberskog majstora koji razume šta hoću. Fade je savršen, krivulje precizne. Vrhunska usluga!',
    text_cyr: 'Коначно сам пронашао берберског мајстора који разуме шта хоћу. Fade је савршен, кривуље прецизне. Врхунска услуга!',
  },
];
...
function renderReviews(l) {
  ...
  REVIEWS.forEach(r => {
    ...
    card.innerHTML = `
      ...
      <p class="review-text">${l === 'lat' ? r.text_lat : r.text_cyr}</p>
    `;
...
function initForm() {
  ...
  form.addEventListener('submit', (e) => {
    e.preventDefault();
    // Demo: just clear the form
    form.reset();
    const note = document.getElementById('form-note');
    note.style.color = '#c9a84c';
    // Restore after 3s
    setTimeout(() => { note.style.color = ''; }, 3000);
  });
}
