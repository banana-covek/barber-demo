...
const REVIEWS = [
  ...
  {
    name: 'Mijan Vukmirović',
    initials: 'MV',
    color: '#1d3557',
    stars: 5,
    date_lat: 'Google recenzija',
    date_cyr: 'Google рецензија',
    text_lat: 'Lalatović voli malo da ga zavrće, ali sve u svemu odlični momci! 😄👍',
    text_cyr: 'Лалатовић воли мало да га заврће, али све у свему одлични момци! 😄👍',
  },
  {
    name: 'Željko Lukić',
    initials: 'ŽL',
